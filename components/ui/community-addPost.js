    ...
    <>
      ...
      <div className="fixed bottom-0 right-0 w-full max-w-[640px] px-10">
        ...
        <div className="relative">
          ...
          <button
            className="absolute right-160 bottom-36 bg-[var(--color-secondary-600)] rounded-full py-6 px-8 text-white font-bold cursor-pointer hover:bg-[var(--color-secondary-300)] shadow-lg"
